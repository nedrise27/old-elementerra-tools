...
export interface UnstakeLostCnftArgs {
...
export interface UnstakeLostCnftAccounts {
...
export function unstakeLostCnft(
  args: UnstakeLostCnftArgs,
  accounts: UnstakeLostCnftAccounts,
  ...
  const identifier = Buffer.from([237, 196, 1, 213, 73, 202, 91, 187])
